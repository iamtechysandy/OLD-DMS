...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 25, 2023 at 08:08 AM
...
ALTER TABLE `folder_permissions`
  ADD CONSTRAINT `fk_folder_permissions_folders` FOREIGN KEY (`folder_id`) REFERENCES `folders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_folder_permissions_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
